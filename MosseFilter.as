...
package {
    ...
    public class MosseFilter {
        ...
        public function MosseFilter(params) {
        ...
        public function load (filter:Object) {
         ...
         public function init (w:int,h:int) {
            ...
            // fft function
            function fft_inplace(array:Array) {
                // in-place
            ...
            function track (input, left, top, width, height, updateFilter, gaussianPrior, calcPSR) {
